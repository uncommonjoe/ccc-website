				...
				<div class="col-12 col-sm-6 col-md-3">
					<?php if ( get_wpfc_sermon_meta( 'sermon_audio' ) || get_wpfc_sermon_meta( 'sermon_audio_id' ) ) : ?>
						<?php
							...
							$sermon_audio_url    = $sermon_audio_id && $sermon_audio_url_wp ? $sermon_audio_url_wp : get_wpfc_sermon_meta( 'sermon_audio' );
						?>
						<a class="btn btn-secondary btn-block margin-sm-top" href="<?php echo $sermon_audio_url; ?>" download="<?php echo basename( $sermon_audio_url ); ?>" title="<?php echo __( 'Download Audio File', 'sermon-manager-for-wordpress' ); ?>">
							Download
						</a>
					<?php endif; ?>
				</div>
