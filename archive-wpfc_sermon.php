				...
				global $post; ?>
					<div class="row" id="latest_sermon">
						...
						<div class="col-12 col-sm-7">
							<h1 class="text-uppercase font-700"><?php the_title(); ?></h1>
							...
							<div class="meta">
								...
								<?php if ( get_wpfc_sermon_meta( 'sermon_audio' ) || get_wpfc_sermon_meta( 'sermon_audio_id' ) ) : ?>
									...
									?>
									<a class="btn btn-secondary margin-md-top" href="<?php echo $sermon_audio_url; ?>" download="<?php echo basename( $sermon_audio_url ); ?>" title="<?php echo __( 'Download Audio File', 'sermon-manager-for-wordpress' ); ?>">
										Download
									</a>
								<?php endif; ?>
							</div>
