		...
		<script src="<?php echo get_template_directory_uri(); ?>/app/controllers/signupListController.js?v1.1.1"></script>
		<script src="<?php echo get_template_directory_uri(); ?>/app/directives/serviceSignupDirective.js?v1.1.1"></script>
